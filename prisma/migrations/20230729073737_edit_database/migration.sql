...
CREATE TABLE "new_Product" (
    ...
    "overwiew" TEXT NOT NULL,
    "featureImage" TEXT NOT NULL,
    "productImage" TEXT NOT NULL,
    "downloadableImage" TEXT NOT NULL,
...
INSERT INTO "new_Product" ("authorId", "downloadableImage", "featureImage", "id", "isDeleted", "name", "overwiew", "productImage", "shortDescription", "slug") SELECT "authorId", "downloadableImage", "featureImage", "id", "isDeleted", "name", "overwiew", "productImage", "shortDescription", "slug" FROM "Product";
DROP TABLE "Product";
